...
// Full PSF research result (includes raw section research)
export interface SectionResearchData {
  content: string;
...
export interface PSFResearchResult {
  problemEvidence: SectionResearchData;
  competitorAnalysis: SectionResearchData;
  marketSignals: SectionResearchData;
